package app.gfghvfg.powered.fdserty.by.gfdf.yalla.gfdfgtty.crud;
...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://burhan43.000webhostapp.com/retieve.php";
    Employee employee;
    @Override
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://burhan43.000webhostapp.com/delete.php",
